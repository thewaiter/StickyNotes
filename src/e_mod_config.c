...
E_Config_Dialog *
e_int_config_sticky_notes_module(E_Container *con, const char *params) 
{
   ...
   cfd = e_config_dialog_new(con, D_("StickyNotes Module"), "Sticky_notes", 
                             "advanced/sticky_notes", buf, 0, v, NULL);
...
_fill_data(E_Config_Dialog_Data *cfdata) 
{
   ...
   cfdata->switch1 = sticky_notes_conf->switch1;
}
...
{
   sticky_notes_conf->switch1 = cfdata->switch1;
   e_config_save_queue();
   return 1;
}
